 ...
 * @LastEditors: 于效仟
 * @LastEditTime: 2019-09-07 11:32:42
 */
...
export const BANNERS = [
  [
    ...
    },
    {
      keywords: ['供应链大数据'],
      text:
        '打通供应链数据孤岛，构建大数据平台，通过大数据分析、算法建模、金融科技等技术，优化供应链各个环节，达到降本增效、提升服务质量（和决策智能）的目标',
    ...
    },
    {
      keywords: ['酒店大数据'],
      text:
        '打通酒店数据孤岛，构建大数据平台，通过大数据分析、用户画像系统、智能硬件等技术，优化酒店各个业务环节，达到降本增效、智能经营的目标',
