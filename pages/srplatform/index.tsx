...
export default () => {
  ...
  const productIntro = {
    text:
      '数融平台主要包含数据集成、数据开发、数据地图、权限管理、运维监控等子系统，是自主研发的一款数据融合产品， 通过可视化图形配置界面即可自服务部署一条实时数据管道，并提供丰富的数据任务调度、平台运维监控、数据资源管理、权限管理等功能，帮助客户打通数据孤岛，构建数据资产平台',
  ...
  const products = [
    ...
    },
    {
      ...
      title: '运维监控',
      desc: '资源、数据、服务的自动化、可视化的统一监控报警系统，实现智能运维。',
    },
    {
